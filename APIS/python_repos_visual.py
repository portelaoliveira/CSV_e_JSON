...
names, stars = [], []
''' As listas vazias vão armazenar o nome de cada projeto para rotular as barras e o nímero de estrelas
    para determinar a altura delas. '''
for repo_dict in repo_dicts:
    names.append(repo_dict['name']) # Nome de cada projeto.
    stars.append(repo_dict['stargazers_count']) # Número de strelas. 
